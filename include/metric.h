...
public: // functions
    ...
    void reset() { m_tensor = EVec10d::Zero(); }
    ...
    void init_qem_metrics_face(const double& area, const Point& query, const Vector& normal)
    {
        ...
        const double d = -1. * CGAL::scalar_product(normal, (query - CGAL::ORIGIN));
    ...
    {
        const double sn2 = std_normal * std_normal;
        const double sq2 = std_query * std_query;
        const double dot_nq = CGAL::scalar_product(mean_normal, (mean_query - CGAL::ORIGIN));
        ...
        const Vector vec_nnq = mean_normal * dot_nq + (mean_query - CGAL::ORIGIN) * sn2;
    ...
    void init_qem_metrics_vertex(const Point& query,
